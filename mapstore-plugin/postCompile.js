...
const extensionsPath = path.join(__dirname, '..', 'externalapplications', 'static', 'mapstore', 'extensions');
...
const EXTENSION_NAME = 'externalapplications';

let error = false;
// Object.keys(extensionIndex).forEach(extensionName => {
//     const endpoints = extensionIndex[extensionName];
//     Object.keys(endpoints).forEach(key => {
//         if (endpoints[key].match('http://localhost:8081/extension')) {
//             error = true;
//             console.error('');
//             console.error('//////////////////////////////////////');
//             console.error('/// Error: dev url ' + key + ': ' + endpoints[key]);
//             console.error('/// -> please replace http://localhost:8081/extension with /static/mapstore/extensions/' + extensionName);
//             console.error('//////////////////////////////////////');
//             console.error('');
//         }
//     });
